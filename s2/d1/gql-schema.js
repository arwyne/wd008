...
const Mutation = new GraphQLObjectType({
  ...
  fields: {
    ...
    deleteMember: {
      ...
      resolve: (parent, args) => {
        let MemberId = { _id: args.id };
        return Member.findByIdAndRemove(MemberId);
      },
    },
    ...
    updateMember: {
      ...
      resolve: (parents, args) => {
        ...
        return Member.findOneAndUpdate(memberId, member);

        // solution ko dati na mali
        // let teamID = {_id: args.id}
        // let firstName = {firstName: args.firstName}
        // let lastName = {lastName: args.lastName}
        // let position = {position: args.position}

        // return Member.findOneAndUpdate(memberId, firstName, function (member) {
        //   return member;
        // });
      },
    },
